...
- del delete the key-value pair from the map using a statement of the form
  del map[key]
- len() return the number of key-value pairs sotred in the map
- in return true / False

A binary search tree relies on the property that values that are less than the
parent are found in the left subtree, and values that are greater than the parent
are found in the right substree. we call it BST property
"""
